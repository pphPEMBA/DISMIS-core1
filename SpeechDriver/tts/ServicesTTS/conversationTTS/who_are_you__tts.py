...
#with open(temporaryfiles + 'who_are_you.txt', 'r') as who_are_you_txt:
#   tts = who_are_you_txt.read()
#   print(tts)
#   speak(tts)
who_are_you_txt = open(temporaryfiles + 'who_are_you.txt','r')
tts = who_are_you_txt.read()
speak(tts)
print(tts)
os.system('rm ' + temporaryfiles + 'who_are_you.txt')