...
weather_DefaultCity_txt = open(temporaryfiles + 'weather_DefaultCity.txt','r')
tts = weather_DefaultCity_txt.read()
speak(tts)
os.system('rm ' + temporaryfiles + 'weather_DefaultCity.txt')
